...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    public ResponseDto registerUser(RegistrationDto registrationDto)  {
        ...
        if (registrationDto == null ||
                registrationDto.getUser() == null ||
                registrationDto.getWork() == null ||
                registrationDto.getApplication() == null ||
                registrationDto.getOwnership() == null ||
                registrationDto.getCertification() == null ||
                registrationDto.getPayment() == null) {
            throw new ValidationException("Registration data is incomplete or invalid.");
        }
        ...
        if (optionalUser.isPresent()) {
            throw new CustomerAlreadyExistsException(
                    "User already registered with mobile number: " + registrationDto.getUser().getPhoneNumber());
        }
        ...
        // Save all objects in the database (Transactional ensures all-or-nothing)
